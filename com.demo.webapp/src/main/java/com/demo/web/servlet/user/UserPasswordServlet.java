...
public class UserPasswordServlet extends BaseServlet {

	private static final long serialVersionUID = 1L;
	private static final String PASSWORD_PATH = "/WEB-INF/jsp/user/password.jsp";
	...
	protected void doJspGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		setJspDispatcher(request, response, PASSWORD_PATH);
