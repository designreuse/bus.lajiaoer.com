...
@WebServlet(asyncSupported = true, urlPatterns = { "/signup/success" })
public class UserSignupSuccessServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	private static final String SIGNUP_SUCCESS_PATH = "/WEB-INF/jsp/user/signup_success.jsp";

	private static final Logger LOGGER = LoggerFactory.getLogger(UserSignupSuccessServlet.class);

	public UserSignupSuccessServlet() {
		super();
	}
	...
	protected void doJspGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		setJspDispatcher(request, response, SIGNUP_SUCCESS_PATH);
