...
@WebServlet(asyncSupported = true, urlPatterns = { "/driver/signup/success" })
public class DriverSignupSuccessServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	private static final String DRIVER_SIGNUP_SUCCESS_PATH = "/WEB-INF/jsp/driver/driver_signup_success.jsp";

	private static final Logger LOGGER = LoggerFactory.getLogger(DriverSignupSuccessServlet.class);

	public DriverSignupSuccessServlet() {
		super();
	}
	...
	protected void doJspGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		setJspDispatcher(request, response, DRIVER_SIGNUP_SUCCESS_PATH);
