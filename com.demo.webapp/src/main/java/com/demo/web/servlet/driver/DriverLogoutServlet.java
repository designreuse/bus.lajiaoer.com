...
@WebServlet(asyncSupported = true, urlPatterns = { "/driver/logout" })
public class DriverLogoutServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	private static final String DEFAULT_LOGOUT_REDIRECT_PATH = "/";
	private static final Logger logger = LoggerFactory.getLogger(DriverLogoutServlet.class);

	public DriverLogoutServlet() {
		super();
	}
