...
@WebServlet(asyncSupported = true, urlPatterns = { "/signup", "signup/" })
public class UserSignupServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	private static final String SIGNUP_PATH = "/WEB-INF/jsp/user/signup.jsp";
	...
	protected void doJspGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		setJspDispatcher(request, response, SIGNUP_PATH);
